...
**T (10 points):** What is the mean and what is the meadian number of connections?

## Computing shortest paths

Shortest paths are the basis for many network measures. We have seen
two algorithms to calculate shortest paths (Dijkstra and Bellman–Ford); now, 
you will need to implement one!
...
**T (10 points), bonus** For very big graphs, computations such as the above
can consume very big amounts of memory due to intermediate objects that
need to be held in memory. One such example is the intermediate array 
that holds the combinations of nodes. One way to deal with this issue is to
create a _generator_ function that will calculate the shortest path every time
it is called. In this **bonus** task, you have to implement this function.
...
friend who has a friend who has a friend who has a friend who knows Knuth.
