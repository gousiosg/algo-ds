...
- **Particle swarm optimization**         
  -- inspired by the social behavior of animals, such as bird flocking or fish
    schooling       
- **Ant colony optimization**
- **Simulated Annealing**          
  -- inspired by the anealing process for material
- **Genetic Algorithm**     
  -- inspired by the natural selection mechanism where the fittest entity has a
...
4. For each particle, calculate the **velocity**, and update the **position** of
  ...
  -- Velocity is calculated based on the position of the current particle and
...
def display(candidate, startTime):
    ...
    print("{}\t{}\t{}".format(
        candidate.Chars, candidate.Fitness, timeDiff))
