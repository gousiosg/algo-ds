...
title: |
  ...
  | **Genetic Algorithms**
author: |
  | ![](./figs/Mozhan Soltani.jpg){width=12%}
  | Mozhan Soltani
  | PhD student 
...
![](./figs/time.svg){width=70%}


## **What is optimization?**
![](./figs/function.svg){width=45%}
...
![Continuous function](./figs/continuous.svg){width=45%}
