...
Like all containers, dynamic sets can grow, shrink, or change over time.

- Dynamic sets support basic operations such as:
...
that can be identified using numerical *indices*.
...
// Insert item = 10 to the location of the 4th element.
int main() {
   int arr[] = {1,2,3,4,5};
   int item = 10, k = 4, n = 5;
   int j = n;
