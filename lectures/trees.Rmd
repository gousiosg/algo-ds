...
We want to remove a node $K$ with $L$ as left node and $R$ as right node

1. Perform a search for a minimum value $Min$ in the right subtree $R$
   or search for a maximum value $Max$ in the left subtree $L$
2. Replace $K$ data value with $Min$ or $Max$ value
3. Remove node where we found the $Min$ or $Max$ in the tree

NB: $K$ should be replaced with value that preserve the properties of a BST
