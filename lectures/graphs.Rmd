...
A closed path in which all the edges are different.
0 - 1 - 3 - 2 - 0
...
```{r,  message=FALSE, warning=FALSE, cache=FALSE, fig.width = 5, fig.height = 4}
fg <- make_empty_graph(10)
plot(fg, vertex.size=20, vertex.label=NA)
```
...
```{r,  message=FALSE, warning=FALSE, cache=FALSE, fig.width = 5, fig.height = 4}
st <- make_star(10)
plot(st, vertex.size=20, vertex.label=NA)
```
...
plot(tr, vertex.size=20, vertex.label=NA)
```
...
```{r,  message=FALSE, warning=FALSE, cache=FALSE, fig.width = 5, fig.height = 4}
rn <- make_ring(10)
plot(rn, vertex.size=20, vertex.label=NA)
```
