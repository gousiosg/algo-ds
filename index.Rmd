...
deadline for the first assignment is on 29/11. You must submit your assignment
by Nov 28, 23:59.
...
| 2 | 1 | [Basic Data Structures](basic-structures.html) (Lists, Stacks, Sets) | MK | [Doubly-linked lists](assignment-lists.ipynb) (29/11/2017) |
| 2 | 2 | Algorithms for basic data structures | MK | |
| 3 | 1 | [Trees](trees.html) (Binary trees)  | JH | [Red-Black Trees](assignment-rbtrees.ipynb) (13/12/2017) |
| 3 | 2 | More Trees (B+ Trees) | JH | |
| 4 | 1 | [Graphs](graphs.html) (Representation and Traversal) | PK | [Graph algorithms](assignment-graphs.ipynb) (10/01/2018)|
| 4 | 2 | Graph algorithms (Topological sorting, Centrality) | PK ||
| 5 | 1 | Sorting | JH | [Searching](assignment-searching.ipynb) (16/01/2018)|
| 5 | 2 | Searching | JH ||
